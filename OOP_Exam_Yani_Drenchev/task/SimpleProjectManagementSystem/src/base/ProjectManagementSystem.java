...
public interface ProjectManagementSystem {
    ...
    void addTicket(String title, String description, Date date,
                   TicketPriority priority, String sender, String owner);

    void addTodo(String title, String description, TodoState state);

    void addTask(String title, String description, Date dueDate, TicketPriority priority,
    ...
    void changeTodoState(String title, String state);
}
